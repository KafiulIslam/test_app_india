...
class _FlutterWifiIoTState extends State<FlutterWifiIoT> {
  ...
  Future<List<WifiNetwork>> loadWifiList() async {
    ...
    try {
      ...
      print('wifi list is $htResultNetwork');
    } on PlatformException {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        leading: IconButton(onPressed: () async {
          _htResultNetwork = await loadWifiList();
          _htResultNetwork?.map((e) {
          //  print('akdjfkjand ** // ** ${e?.ssid}');
            showDialog(context: context, builder: (context){
              return AlertDialog(content: Text(e!.ssid.toString()),);
            });
            wifiN = e!.ssid.toString();
          });
          setState(() {});
         // getWifiList();
        }, icon: Icon(Icons.add)),
